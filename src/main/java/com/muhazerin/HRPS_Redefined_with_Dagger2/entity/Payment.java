 ...
 * 
 * @author Nasran
 * @author https://github.com/Skyfall222
 *
 */
...
public class Payment {
	...
	private void getRoomServicePriceList() {
		...
		for (RoomService roomService : rsL) {
			...
			roomService.setRoomServiceStatus(RoomService.RoomServiceStatus.DELIVERED);
	...
	public void pay() {
		...
		do {
			...
			case 2:
				...
				System.out.println("Type: " + rs.getGuest().getCreditCard().getCardType());
